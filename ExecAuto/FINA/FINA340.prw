...
User Function CMPCPAUT()
 ...
 Private aCores := 	{	{'E2_SALDO = E2_VALOR .AND. E2_ACRESC'	,'ENABLE'		,NIL},;
				{'E2_SALDO =  0','DISABLE'		,NIL},;
				{'E2_SALDO <> 0'	,'BR_AZUL'	,NIL} }	
...
PRIVATE aRotina := {  { "Pesquisar","AxPesqui"  , 0 , 1,,.F., nil },;  //"Pesquisar"      
